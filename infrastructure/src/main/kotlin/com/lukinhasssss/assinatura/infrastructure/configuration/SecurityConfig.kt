...
class SecurityConfig {
    ...
    private class KeycloakJwtConverter(
        ...
        private fun extractAuthorities(jwt: Jwt): Collection<GrantedAuthority>? = authoritiesConverter.convert(jwt)
    }
    ...
    private class KeycloakAuthoritiesConverter : Converter<Jwt, Collection<GrantedAuthority>> {
        ...
        private fun MutableSet<MutableMap.MutableEntry<String, Any>>.mapResources() = stream().flatMap { it.mapResource() }.toList()
